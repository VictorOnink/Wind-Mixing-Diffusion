...
def run():
    ...
    #                                    boundary='Reflect_Markov', selection='w_10', single_select=0, close_up=(0, -30))
    ...
    # visualization.timestep_comparison(w_10_list=[6.65], w_rise_list=[-0.03],
    #                                   close_up=(0, -100), diffusion_type='KPP', interval=2,
