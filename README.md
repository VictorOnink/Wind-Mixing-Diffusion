[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.5886711.svg)](https://doi.org/10.5281/zenodo.5886711)
...
This repository contains all the code for the vertical wind mixing experiments described in [Onink et al. (2022)](http://dx.doi.org/10.5194/gmd-2021-195): "*Empirical Lagrangian parametrization for wind-driven mixing of buoyant particulates at the ocean surface*". Using
...
All these files and directories can be found within the ```src``` directory.
